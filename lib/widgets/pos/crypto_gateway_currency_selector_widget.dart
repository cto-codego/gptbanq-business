...
import '../../Models/pos/crypto_gateway_currency_list_model.dart';
import '../../utils/custom_style.dart';
import '../../utils/input_fields/custom_color.dart';
import '../buttons/custom_icon_button_widget.dart';
import '../custom_image_widget.dart';

class CryptoGatewayCurrencySelectorWidget extends StatefulWidget {
  final TextEditingController controller;
  final String label;
  final String hint;
  final List<CryptoGatewayCurrency> currencies;
  final Function(String?)? onCurrencySelected;

  const CryptoGatewayCurrencySelectorWidget({
    super.key,
  ...
  @override
  State<CryptoGatewayCurrencySelectorWidget> createState() =>
      _CryptoGatewayCurrencySelectorWidgetState();
}

class _CryptoGatewayCurrencySelectorWidgetState
    extends State<CryptoGatewayCurrencySelectorWidget> {
  FocusNode myFocusNode = FocusNode();
  bool isBorderHighlighted = false;
  String searchQuery = '';
  String? selectedFlag; // New variable to store selected flag URL
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            // Display the selected flag in the prefixIcon
            prefixIcon: selectedFlag != null
                ? Padding(
                    ...
                    child: Image.network(
                      ...
                      errorBuilder: (BuildContext context, Object exception,
                        ...
                        return Icon(
                            Icons.flag); // Replace with any fallback icon
                      },
                    ),
                  )
                : null,
  ...
  // Builds individual currency list items
  Widget _buildCurrencyItem(CryptoGatewayCurrency currency) {
    return InkWell(
      onTap: () {
        Navigator.pop(context);
        widget.controller.text = currency.currency!;
        selectedFlag = currency.flag;
        ...
        if (widget.onCurrencySelected != null) {
          widget.onCurrencySelected!(currency.currency);
        }
      },
      child: Container(
            ...
            Image.network(
              ...
              errorBuilder: (BuildContext context, Object exception,
                ...
                return Icon(Icons.info,
                    size: 24); // Replace with any icon you want
              },
            ),
