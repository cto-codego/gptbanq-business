      ...
      decoration: InputDecoration(
        ...
        prefixIcon: flag != null
            ? Padding(
                ...
                child: Image.network(
                  flag!, // Use the flag of the selected currency
                  width: 24,
                  height: 24,
                  fit: BoxFit.contain,
                ),
...
class _IbanSelectionModal extends StatefulWidget {
  final List<IbanListData> ibans;
  final ValueChanged<IbanListData> onSelectIban;
...
class _IbanSelectionModalState extends State<_IbanSelectionModal> {
  late List<IbanListData> filteredIbans;
