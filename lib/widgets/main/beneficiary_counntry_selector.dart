...
class BeneficiaryCountrySelector extends StatefulWidget {
  ...
  const BeneficiaryCountrySelector({
    super.key,
  ...
  @override
  State<BeneficiaryCountrySelector> createState() =>
      _BeneficiaryCountrySelectorState();
}

class _BeneficiaryCountrySelectorState
    extends State<BeneficiaryCountrySelector> {
  FocusNode myFocusNode = FocusNode();
  bool isBorderHighlighted = false;
  String searchQuery = '';
  String? selectedFlag; // New variable to store selected flag URL
  String? countryName; // New variable to store selected flag URL
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (buildContext, setState) {
            ...
            final filteredCurrencies = widget.countries
  ...
  Widget _buildCurrencyItem(country) {
    return InkWell(
      onTap: () {
        Navigator.pop(context);
        widget.controller.text = country.name;
        selectedFlag = country.flag; // Update selected flag URL
        ...
        if (widget.onCurrencySelected != null) {
          widget.onCurrencySelected!(country.code);
        }
      },
      child: Container(
