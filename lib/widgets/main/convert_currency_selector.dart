...
class ConvertCurrencySelector extends StatefulWidget {
  ...
  @override
  State<ConvertCurrencySelector> createState() => _ConvertCurrencySelectorState();
}

class _ConvertCurrencySelectorState extends State<ConvertCurrencySelector> {
        ...
        return StatefulBuilder(
          builder: (buildContext, setState) {
            ...
            final filteredCurrencies = widget.currencies
                .where((currency) => currency.convertCurrencyList
                .toLowerCase()
  ...
  Widget _buildCurrencyItem(currency) {
    return InkWell(
      onTap: () {
        ...
        widget.controller.text = currency.convertCurrencyList;
        setState(() {
          isBorderHighlighted = true;
        });
        // Trigger the onChanged callback
        if (widget.onChanged != null) {
          widget.onChanged!(currency.convertCurrencyList);
        }
      },
      child: Container(
        ...
        child: Row(
          children: [
            Image.network(currency.flag ?? '', width: 24, height: 24),
            const SizedBox(width: 10),
            Text(
              currency.convertCurrencyList,
              style: GoogleFonts.inter(
