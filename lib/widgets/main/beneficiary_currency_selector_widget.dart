...
class BeneficiaryCurrencySelectorWidget extends StatefulWidget {
  final TextEditingController controller;
  final String label;
  final String hint;
  final List<Curreny> currencies;
  final Function(String?)? onCurrencySelected;

  const BeneficiaryCurrencySelectorWidget({
    super.key,
  ...
  @override
  State<BeneficiaryCurrencySelectorWidget> createState() => _BeneficiaryCurrencySelectorWidgetState();
}

class _BeneficiaryCurrencySelectorWidgetState extends State<BeneficiaryCurrencySelectorWidget> {
            ...
            prefixIcon: selectedFlag != null
              ...
              child: Image.network(
                ...
                errorBuilder: (BuildContext context, Object exception, StackTrace? stackTrace) {
                  return Icon(Icons.flag); // Replace with any fallback icon
                },
              ),
            )
                : null,
  ...
  Widget _buildCurrencyItem(currency) {
    return InkWell(
      onTap: () {
        ...
        widget.controller.text = currency.code;
        selectedFlag = currency.name;
        ...
        child: Row(
          children: [
            Image.network(
              ...
              height: 24,
              errorBuilder: (BuildContext context, Object exception, StackTrace? stackTrace) {
                return Icon(Icons.info, size: 24); // Replace with any icon you want
              },
            ),
