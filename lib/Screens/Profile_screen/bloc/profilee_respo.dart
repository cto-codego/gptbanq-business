...
import 'package:gptbanqbusiness/Models/profile/chnage_password_model.dart';
import 'package:gptbanqbusiness/Models/profile/logout_model.dart';
import 'package:gptbanqbusiness/Models/profile_info.dart';
...
import '../../../Models/profile/pay_with_model.dart';
...
class ProfileRespo {
  ...
  Future payWith({
    ...
    try {
      ...
      debugPrint("payWith bodyData");
      debugPrint(bodyData.toString());
      Response? response = await NetworkManager().callApi(
          method: HttpMethod.Post,
          body: bodyData,
          urlEndPoint: AppConfig.payWith);

      debugPrint("response : $response");
      Map<String, dynamic> jsonResponse = jsonDecode(response!.data);
      return PayWithModel.fromJson(jsonResponse);
    } on ApiException catch (e) {
      debugPrint(e.toString());
      // ignore: use_rethrow_when_possible
      throw (e);
