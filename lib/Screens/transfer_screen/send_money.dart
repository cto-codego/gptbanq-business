                            ...
                            Form(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (state.ibanlistModel!.ibaninfo!.isNotEmpty)
                                    Column(
                                      crossAxisAlignment:
                                          CrossAxisAlignment.start,
                                      children: [
                                        ...
                                        DropDownTextField(
                                          ...
                                          onChanged: (val) {
                                            ...
                                            setState(() {
                                              ...
                                              var selectedIbanInfo = state
                                                  .ibanlistModel!.ibaninfo!
                                                  .firstWhere(
                                                (iban) => iban.ibanId == ibanid,
                                              );

                                              if (selectedIbanInfo != null) {
                                                String provider = selectedIbanInfo
                      ...
                      onPressed: active
                          ? () {
                              if (_formKey.currentState!.validate()) {
                                ...
                                if (widget.accountType == "swift" ||
                                    widget.accountType == "local faster") {
