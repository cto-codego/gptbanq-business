...
class UpdateAddressPreviewScreen extends StatefulWidget {
  final File imageFile;

  UpdateAddressPreviewScreen({super.key, required this.imageFile});

  @override
  State<UpdateAddressPreviewScreen> createState() =>
      _UpdateAddressPreviewScreenState();
}

class _UpdateAddressPreviewScreenState
    extends State<UpdateAddressPreviewScreen> {
