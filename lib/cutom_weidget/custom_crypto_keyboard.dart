...
class CustomCryptoKeyboard extends StatelessWidget {
  final String currency;
  final TextEditingController? pinController;
  final Function(String)? onChange;

  const CustomCryptoKeyboard({
    super.key,
      ...
      return buttonContainer(
        child: ElevatedButton(
          ...
          onPressed: () {
            ...
            if (onChange != null) {
              onChange!(
                  pinController!.text); // Call onChange with the updated text
            }
          },
          child: Center(
            child: Text(
              ...
              buttonContainer(
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    if (onChange != null) {
                      onChange!(pinController!
                          .text); // Call onChange with the updated text
                    }
                  },
                  child: Text(
